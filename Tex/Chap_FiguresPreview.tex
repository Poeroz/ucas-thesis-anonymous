...
\begin{tikzpicture}[
    ...
    % 第三层：编码器-解码器 (x=0.8, x=4.2)
    \node[box=teal, minimum width=2.8cm] (s2tt) at (0.8, -3.5) {语音到文本翻译};
    \node[box=blue, minimum width=2.8cm] (s2st) at (4.2, -3.5) {语音到语音翻译};
    \node[sec, below=0.02cm of s2tt] {（\S 2.3.2）};
    \node[sec, below=0.02cm of s2st] {（\S 2.3.3）};

    % 第三层：仅解码器 (x=6.8, x=10.2)
    \node[box=orange, minimum width=2.8cm] (s2t_llm) at (6.8, -3.5) {语音理解大模型};
    \node[box=red, minimum width=2.8cm] (s2s_llm) at (10.2, -3.5) {语音交互大模型};
